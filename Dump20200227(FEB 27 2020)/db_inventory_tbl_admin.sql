...
INSERT INTO `tbl_admin` VALUES ('ID123423455223423423434','admin123','admin123','admin','admin','admin','Admin','Active','admin','admin','admin','admin','admin','admin'),('ID0227202084658','administrator','admin','admin','admin','admin','Admin','Active','What is your first girlfriend\'s/boyfriend\'s name?','admin','Who is your favorite historical person?','admin','What\'s the nickname of your oldest child?','admin');
