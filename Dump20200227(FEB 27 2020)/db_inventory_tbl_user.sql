...
INSERT INTO `tbl_user` VALUES ('ID0227202084736','User','user','user','user','user','User','Active','What is your favorite foor?','user','What is the name of your favorite childhood friend?','user','What\'s the nickname of your oldest child?','user');
